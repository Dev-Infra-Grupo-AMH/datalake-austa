-- Bronze ATENDIMENTO_PACIENTE: Raw Avro (stream) → Iceberg
...
{% set raw_path = "s3a://" ~ var('datalake_bucket') ~ "/" ~ var('raw_tasy_stream_prefix') ~ var('raw_tasy_stream_topic_atendimento_paciente') ~ "/" %}
