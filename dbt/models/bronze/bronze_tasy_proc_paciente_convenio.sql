-- Bronze PROC_PACIENTE_CONVENIO: Raw Avro (stream) → Iceberg
...
{% set raw_path = "s3a://" ~ var('datalake_bucket') ~ "/" ~ var('raw_tasy_stream_prefix') ~ var('raw_tasy_stream_topic_proc_paciente_convenio') ~ "/" %}
