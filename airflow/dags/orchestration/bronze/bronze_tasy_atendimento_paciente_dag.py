...
esta DAG executa o modelo dbt bronze_tasy_atendimento_paciente.
"""
...
@dag(
    ...
    tags=["bronze", "dbt", "tasy", "atendimento_paciente"],
)
def bronze_tasy_atendimento_paciente_dag():
    run_bronze = BashOperator(
        ...
        bash_command=(
            ...
            f"PYTHONPATH={PYTHONPATH} dbt run --select bronze_tasy_atendimento_paciente"
        ),
    )
    run_bronze
